...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public Result<?> getUserInfo(String token) {
        ...
        //long userId = Long.parseLong(jwtSecurityProperties.parseToken(token,"userId"));
    ...
    public Result<?> registerUser(@NotNull User user) {
        ...
        ResultCodeEnum codeEnum = ResultCodeEnum.USERNAME_USED;
        String getEnumMsg = codeEnum.getMessage();
        if(result.getMsg().equals(getEnumMsg)) {
            return result;
        }
